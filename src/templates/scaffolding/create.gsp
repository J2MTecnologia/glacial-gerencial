				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i><g:message code="default.create.label" args="[entityName]" />
							</div>
							<div class="tools">
							...
							<g:form url="[resource:${propertyName}, action:'save']" <%= multiPart ? ' enctype="multipart/form-data"' : '' %> class="form-horizontal">
								...
								<div class="form-actions right">
									<div class="col-md-offset-3 col-md-9">
										<g:submitButton name="create" class="btn green" value="\${message(code: 'default.button.create.label', default: 'Create')}" />
									</div>
								</div>
							</g:form>
						</div>
