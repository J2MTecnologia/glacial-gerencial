...
<div class="logo">
	<a href="/">
		<img src="/img/logo_login.png" alt="logo" class="img-responsive"/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="${postUrl}" method="post" name="loginForm" autocomplete='off'>
		...
		<div class="form-actions">
			...
			<input type="checkbox" name="${rememberMeParameter}" value="1"/> Remember me </label>
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	2014 &copy; AppMembers.com.br developed by <a href="leonn.github.io">Leonn Paiva</a>
</div>
<!-- END COPYRIGHT -->
...
<script src="/js/custom/login-soft.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
